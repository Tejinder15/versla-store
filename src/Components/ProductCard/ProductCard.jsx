        ...
        <div className="basic-card">
            <div className="basic-card-image-title badge-image-title">
                <div className="product-image-container">
                    ...
                    <span className={`dot ${props.productInWishlist(props.productId) && "heart-filled"}`}><span className="material-icons-outlined" onClick={()=>props.productWishlistAction(props.productId)}>{(props.productInWishlist(props.productId)?"favorite":"favorite_border")}</span></span>
            </div>
